...
timevars = { ...
    ...
    'online_reg_rift_started', ...
    'online_reg_rift_stopped', ...
...
for r = 1:nruns
    ...
    trialtimes_rift{r}.online_reg_started = trialtimes_rift{r}.online_reg_rift_started;
    trialtimes_rift{r}.online_reg_stopped = trialtimes_rift{r}.online_reg_rift_stopped;
